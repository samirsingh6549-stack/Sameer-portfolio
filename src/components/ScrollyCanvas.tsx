...
export default function ScrollyCanvas() {
  ...
  return (
    <div className="sticky top-0 left-0 w-full h-screen overflow-hidden bg-[#0a0a0a] z-0">
      ...
      {/* Discrete Corner Monogram Badge (Secret Theme Switcher) */}
      <div className="absolute bottom-0 right-0 z-[100] pb-2 pr-4 md:pb-4 md:pr-6 pointer-events-auto">
        <div className="relative flex items-center justify-center">
          ...
          <motion.button 
            ...
            className="bg-[#0a0a0a]/90 backdrop-blur-2xl border-t border-l border-white/10 px-5 py-2.5 rounded-tl-xl shadow-2xl overflow-hidden min-w-[75px] min-h-[45px] flex items-center justify-center cursor-pointer transition-all hover:border-primary/40 group"
          >
            <h1 
              className="font-display font-black text-xl md:text-2xl tracking-wider text-[#FFD700] drop-shadow-md leading-none group-hover:scale-105 transition-transform"
